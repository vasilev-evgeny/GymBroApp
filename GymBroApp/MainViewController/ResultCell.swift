...
class ResultCell : UICollectionViewCell {
    ...
    private func setConstraints() {
        ...
        NSLayoutConstraint.activate([
            equipLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 10),
            equipLabel.centerXAnchor.constraint(equalTo: backgroundImageView.centerXAnchor),
            equipLabel.leadingAnchor.constraint(equalTo: backgroundImageView.leadingAnchor, constant: 10),
            equipLabel.trailingAnchor.constraint(equalTo: backgroundImageView.trailingAnchor, constant: -10)
        ])
    }
